...
- `cuda_replay_evidence_v1.2.3.zip` - sanitized completed replay evidence;
...
The Level-C and CUDA-evidence ZIP payloads preserve the verified v1.1.4
scientific provenance; only their v1.2.3 release filenames change:
