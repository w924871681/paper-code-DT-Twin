...
METHOD_META: Mapping[str, tuple[str, str, str]] = {
    ...
    "Meta+NAS-lite": ("Meta+NAS-lite", "meta_nas_lite", "search baseline"),
...
def _table2(root: Path) -> list[dict[str, str]]:
    ...
    rows = (
        ...
        ("Meta+NAS-lite", "Meta+NAS-lite", "Top-12 shortlist", "Baseline-specific initialization bank", "Adam/Huber-50", "<=12", "Before candidate evaluation"),
