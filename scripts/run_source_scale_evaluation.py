...
import argparse
from experiments.main.pipeline import run_source_scale_eval
...
a=p.parse_args(); obj=run_source_scale_eval(os.path.abspath(a.project_root),os.path.abspath(a.bank_dir),os.path.abspath(a.out),a.device,a.safe_mode,a.smoke); print(obj['decision'])
