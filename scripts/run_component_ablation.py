...
import argparse
from experiments.main.pipeline import run_ablation_pool
...
a=p.parse_args(); obj=run_ablation_pool(os.path.abspath(a.project_root),os.path.abspath(a.out),a.device,a.safe_mode,a.smoke); print(obj['decision'])
